...
void LookAndFeel::drawButtonBackground(juce::Graphics &g,
    ...
    edgeHighlightPath.addArc(buttonArea.getRight() - cornerSize * 2, buttonArea.getY(), cornerSize * 2, cornerSize * 2,
    ...
    edgeShadowPath.addArc(buttonArea.getRight() - cornerSize * 2, buttonArea.getBottom() - cornerSize * 2,
                          cornerSize * 2, cornerSize * 2, juce::MathConstants<float>::pi,
    ...
    edgeShadowPath.addArc(buttonArea.getX(), buttonArea.getY(), cornerSize * 2, cornerSize * 2,
